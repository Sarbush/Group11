...
$page_title = "Add CD or Audiobook";
require_once 'includes/header.php';
?>

<h2>Add New CD or Audiobook</h2>
<form action="intertcds_audiobooks.php" method="post">
    ...
    <div class="bookstore-button">
        <input type="submit" value="Add CD or Audiobook" />
        <input type="button" value="Cancel" onclick="window.location.href='cd-audiobooks.php'" />
    </div>
</form>
